...
pub struct Layout {
    ...
    clock: Clock,
    layout: tiri::layout::Layout<TestWindow>,
    start_time: Duration,
...
impl Layout {
    pub fn new(args: Args) -> Self {
        ...
        let options = Options {
            layout: tiri_config::Layout {
                ...
                border: tiri_config::Border {
                    ...
                    focused_inactive_color: Color::from_rgba8_unpremul(50, 50, 50, 255),
        ...
        let mut layout = tiri::layout::Layout::with_options(clock.clone(), options);
