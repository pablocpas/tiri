...
use tiri_config::{Color, Config, CornerRadius, GradientInterpolation, WindowRule};
    ...
    fn render_popups<R: NiriRenderer>(
        ...
        for (popup, offset) in PopupManager::popups_for_surface(surface) {
            let popup_rules = match popup {
                ...
                PopupKind::InputMethod(_) => tiri_config::ResolvedPopupsRules::default(),
            };
